...
def question2(image_input):
    ...
    plt.figure()
    plt.subplot(1,3,1)
    plt.imshow(np.real(img1) , cmap='gray') # ilpf
    plt.subplot(1,3,2)
    plt.imshow(np.real(img2), cmap='gray') # blpf
    plt.subplot(1,3,3)
...
if __name__ == '__main__':
    image_input_list = [r"digit_image_pocessing\Lab3\translated_rectangle.tif",r"digit_image_pocessing\Lab3\characters_test_pattern.tif",r"digit_image_pocessing\Lab3\characters_test_pattern.tif",r"digit_image_pocessing\Lab3\blurry_moon.tif",r"digit_image_pocessing\Lab3\cassini.tif"]
