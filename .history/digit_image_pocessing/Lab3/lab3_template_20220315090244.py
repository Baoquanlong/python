...
#     plt.figure()
#     plt.subplot(1,3,1)
#     plt.imshow( , cmap='gray') # ilpf
#     plt.subplot(1,3,2)
#     plt.imshow( , cmap='gray') # blpf
#     plt.subplot(1,3,3)
#     plt.imshow( , cmap='gray') # glpf
...
if __name__ == '__main__':
    ...
    image = plt.imread(r"digit_image_pocessing\Lab3\translated_rectangle.tif")

    question1(image_input=image)
